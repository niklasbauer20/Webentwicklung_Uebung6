...
<form action="mitglieder/submit_edit" method="post">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="username" disabled name="username" value="<?=isset($person['username']) ? $person['username']: ''?>">
    </div>
    <div class="form-group">
        <label for="email" class="form-label">E-Mail-Adresse:</label>
        <input type="text" class="form-control" id="email" name="email" disabled value="<?=isset($person['e-mail']) ? $person['e-mail']: ''?>">
    </div>
